# 2022 Spring "Biostats and Big Data" at SKKU GBME
...
------| ------ | ----- | --------
**Week 1** |
2/21  | V00: Class intro | | |<!--Course overview | Survey (this will be posted later)<br> | -->
...
**Week 6** | | | |
3/28 | V09: Design Experiment <br> if possible, activity regression to the mean<!--<br> Please complete [Quiz]()-->|  | Ch.11-12  |
